          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center pl-0 md:pl-10">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  />
                  <UserIcon className="h-5 w-5 text-white/50 absolute left-3 top-1/2 transform -translate-y-1/2" />
                </div>
              </div>
              ...
              <div className="flex items-start mt-2">
                <div className="flex items-center h-5">
                  <input
                    required
                    id="terms"
                    name="terms" // ✅ Added name
                    type="checkbox"
                    checked={isChecked}
                    onChange={() => setIsChecked(!isChecked)}
                    className="sr-only peer" // ✅ Use sr-only instead of hidden
                  />
                  <div
                    onClick={() => setIsChecked(!isChecked)}
                    className={`h-5 w-5 rounded border cursor-pointer flex items-center justify-center transition ${
                      isChecked
                ...
                <label htmlFor="terms" className="ml-3 block text-sm">
                  <span className="text-white/80">I agree to the </span>
                  <a
                    href="#"
            ...
            <div className="mt-6 text-center">
              <p className="text-white/80 text-sm flex w-full gap-2">
                ...
                >
                  Login <ArrowRightIcon className="h-4 w-4 ml-1" />
                </Link>
              </p>
            </div>
          </div>
